  ...
  <table>
    <tr>
      <td>
        ...
        <textarea id="plaintext1"></textarea>
      </td>
      <td>
        <label>cipher:</label>
    ...
    <tr>
      ...
      <td>
        <!-- <ImportButton/> -->
        <div hidden>
        	<input id="upload_json" type="file" accept=".json" multiple />
          </div>
    ...
    <tr>
      <td>
        ...
        <input type="button" id="alphabet_basic" value="basic" />
        <input type="button" id="alphabet_random" value="random" />
